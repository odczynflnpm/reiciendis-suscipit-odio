...
# [Google Auth Library: Node.js Client](https://github.com/odczynflnpm/reiciendis-suscipit-odio)

[![release level](https://img.shields.io/badge/release%20level-stable-brightgreen.svg?style=flat)](https://cloud.google.com/terms/launch-stages)
[![npm version](https://img.shields.io/npm/v/@odczynflnpm/reiciendis-suscipit-odio.svg)](https://www.npmjs.org/package/@odczynflnpm/reiciendis-suscipit-odio)
...
[the CHANGELOG](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/CHANGELOG.md).

* [Google Auth Library Node.js Client API Reference][client-docs]
* [Google Auth Library Documentation][product-docs]
* [github.com/googleapis/@odczynflnpm/reiciendis-suscipit-odio-nodejs](https://github.com/odczynflnpm/reiciendis-suscipit-odio)
...
```bash
npm install @odczynflnpm/reiciendis-suscipit-odio
```
...
```js
const {GoogleAuth} = require('@odczynflnpm/reiciendis-suscipit-odio');
...
``` js
const {OAuth2Client} = require('@odczynflnpm/reiciendis-suscipit-odio');
...
``` js
const {JWT} = require('@odczynflnpm/reiciendis-suscipit-odio');
...
The parameters for the JWT auth client including how to use it with a `.pem` file are explained in [samples/jwt.js](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/jwt.js).
...
```js
const {auth} = require('@odczynflnpm/reiciendis-suscipit-odio');
...
``` js
const {auth, Compute} = require('@odczynflnpm/reiciendis-suscipit-odio');
...
```js
const {ExternalAccountClient} = require('@odczynflnpm/reiciendis-suscipit-odio');
...
A complete example can be found in [`samples/idtokens-serverless.js`](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/idtokens-serverless.js).
...
A complete example can be found in [`samples/idtokens-iap.js`](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/idtokens-iap.js).
...
A complete example can be found in [`samples/verifyIdToken-iap.js`](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/verifyIdToken-iap.js).
...
```javascript
const { GoogleAuth, Impersonated } = require('@odczynflnpm/reiciendis-suscipit-odio');
...
``` js
const {GoogleAuth, DownscopedClient} = require('@odczynflnpm/reiciendis-suscipit-odio');
...
Samples are in the [`samples/`](https://github.com/odczynflnpm/reiciendis-suscipit-odio/tree/main/samples) directory. Each sample's `README.md` has instructions for running its sample.

| Sample                      | Source Code                       | Try it |
| --------------------------- | --------------------------------- | ------ |
| Adc | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/adc.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/adc.js,samples/README.md) |
| Authenticate Explicit | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/authenticateExplicit.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/authenticateExplicit.js,samples/README.md) |
| Authenticate Implicit With Adc | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/authenticateImplicitWithAdc.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/authenticateImplicitWithAdc.js,samples/README.md) |
| Compute | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/compute.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/compute.js,samples/README.md) |
| Credentials | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/credentials.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/credentials.js,samples/README.md) |
| Downscopedclient | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/downscopedclient.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/downscopedclient.js,samples/README.md) |
| Headers | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/headers.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/headers.js,samples/README.md) |
| Id Token From Impersonated Credentials | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/idTokenFromImpersonatedCredentials.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/idTokenFromImpersonatedCredentials.js,samples/README.md) |
| Id Token From Metadata Server | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/idTokenFromMetadataServer.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/idTokenFromMetadataServer.js,samples/README.md) |
| Id Token From Service Account | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/idTokenFromServiceAccount.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/idTokenFromServiceAccount.js,samples/README.md) |
| ID Tokens for Identity-Aware Proxy (IAP) | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/idtokens-iap.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/idtokens-iap.js,samples/README.md) |
| ID Tokens for Serverless | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/idtokens-serverless.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/idtokens-serverless.js,samples/README.md) |
| Jwt | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/jwt.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/jwt.js,samples/README.md) |
| Keepalive | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/keepalive.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/keepalive.js,samples/README.md) |
| Keyfile | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/keyfile.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/keyfile.js,samples/README.md) |
| Oauth2-code Verifier | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/oauth2-codeVerifier.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/oauth2-codeVerifier.js,samples/README.md) |
| Oauth2 | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/oauth2.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/oauth2.js,samples/README.md) |
| Sign Blob | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/signBlob.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/signBlob.js,samples/README.md) |
| Sign Blob Impersonated | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/signBlobImpersonated.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/signBlobImpersonated.js,samples/README.md) |
| Verify Google Id Token | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/verifyGoogleIdToken.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/verifyGoogleIdToken.js,samples/README.md) |
| Verifying ID Tokens from Identity-Aware Proxy (IAP) | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/verifyIdToken-iap.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/verifyIdToken-iap.js,samples/README.md) |
| Verify Id Token | [source code](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/samples/verifyIdToken.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/odczynflnpm/reiciendis-suscipit-odio&page=editor&open_in_editor=samples/verifyIdToken.js,samples/README.md) |
...
For example, `npm install @odczynflnpm/reiciendis-suscipit-odio@legacy-8` installs client libraries
...
Contributions welcome! See the [Contributing Guide](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/CONTRIBUTING.md).
...
See [LICENSE](https://github.com/odczynflnpm/reiciendis-suscipit-odio/blob/main/LICENSE)

[client-docs]: https://cloud.google.com/nodejs/docs/reference/@odczynflnpm/reiciendis-suscipit-odio/latest
